...
\begin{frame}{Un poco de data...}
    \begin{itemize}%[<+->]
        \item Mumuki es una plataforma educativa para la enseñanza de programación.
...
\begin{frame}{Mumuki Query Learning :: Objetivos}
    ...
    \begin{itemize}
        \item Comprender mejor los conceptos recibido
...
\begin{frame}{MQL :: Herramientas a Implementar}
    \begin{itemize}%[<+->]
        \setlength\itemsep{1em}
        \item Docker container con PostgreSQL
